...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { description: @startup.description, name: @startup.name, price: @startup.price, url: @startup.url }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { description: @startup.description, name: @startup.name, price: @startup.price, url: @startup.url }
    assert_redirected_to startup_path(assigns(:startup))
  end
